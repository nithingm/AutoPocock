...
The image proves the local Docker runner boundary can carry both supported provider CLIs without relying on host tools. Production deployment still needs a registry/tag decision and an explicit credential package policy.
