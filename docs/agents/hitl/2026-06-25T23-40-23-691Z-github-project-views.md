...
Generated: 2026-06-25T23:40:23.691Z
...
- browser_ui_automation (last_resort): A one-off browser automation helper can drive the GitHub UI from an authenticated browser session, but it should stay outside core automation because Project view UI selectors and flows are not stable contracts.
