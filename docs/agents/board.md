...
- The `Claim Lock Audit` GitHub Actions workflow runs the JSON audit on a schedule, writes a GitHub Actions run-summary dashboard, and uploads the report artifact.
