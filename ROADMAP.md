...
- How to package the distributed GitHub ref lock path for always-on multi-runner deployments beyond the landed scheduler dispatch policy, `claim-locks` audit/cleanup, and JSON report contract, including continuous monitors and deployed operator dashboards.
