...
- How to package the distributed GitHub ref lock path for always-on multi-runner deployments beyond the landed scheduler dispatch policy, `claim-locks` audit/cleanup, JSON report contract, and scheduled audit workflow, including deployed operator dashboards.
